...
function renderPredictions(preds) {
  ...
  predictionsEl.innerHTML = Object.entries(preds).map(([k, v]) => `
    <article class="pred-card">
      ...
      <div class="${v.direction === 'naik' ? 'positive' : 'negative'}">
        Arah: ${v.direction.toUpperCase()} (${(v.expected_return * 100).toFixed(2)}%)
      </div>
      <div class="range">Kekuatan Arah: ${v.direction_strength}%</div>
